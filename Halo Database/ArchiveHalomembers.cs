...
{
    public partial class ArchiveHalomembers
    {
        ...
        public string HaloMemberActive { get; set; }
        public string HaloMemberDataKey { get; set; }
        public string HaloMemberLoadDate { get; set; }
        public string HaloMemberWelcomeEmailSent { get; set; }
        public string HaloMemberHash { get; set; }
        public string HaloMemberIsHashed { get; set; }
        public string HaloMemberVat { get; set; }
        public string HaloMemberActivateDate { get; set; }
        public string HaloMemberModifiedDate { get; set; }
