...
namespace PanicButtonBackend
{
    public partial class Halomembers
    {
        ...
        public DateTime? HaloMemberLoadDate { get; set; }
        ...
        public DateTime? HaloMemberActivateDate { get; set; }
        public DateTime? HaloMemberModifiedDate { get; set; }
        public string HaloMemberFullName { get; set; }
        public string HaloMemberBranch { get; set; }
